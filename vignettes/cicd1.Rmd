---
title: "Quality assessment and enhancement approaches for Bioconductor"
author: "Vincent J. Carey, stvjc at channing.harvard.edu"
date: "`r format(Sys.time(), '%B %d, %Y')`"
vignette: >
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteIndexEntry{Quality assessment and enhancement approaches for Bioconductor}
...
curd = getwd()
setwd(td)
file.copy(system.file("demo_srcs", package="BiocQE"), td, recursive=TRUE)
...
```{r lkdesc}
setwd(td)
dcf = read.dcf("demo_srcs/IRanges/DESCRIPTION")
cat(dcf[,"Imports"])
cat("\n")
setwd(curd)
```
...
Here is a screen shot of the `browse_checks` app in BiocQE
